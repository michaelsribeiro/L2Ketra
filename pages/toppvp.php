            ...
            <?php
                ...
                if(mysqli_num_rows($sql) > 0) {
                    while($fetch = mysqli_fetch_assoc($sql)){
                        ...
                        ?>
                        <tr class="row">
                            <td class="pos"><?php echo $i; ?></td>
                            <td class="name-strong"><?php echo $fetch['char_name']; ?></td>
                            <td><?php $trace = '-'; empty($fetch['clan_name']) ? $trace : $fetch['clan_name']; ?></td>
                            <td>-</td>
                            <td class="pvp"><?php echo $fetch['pvpkills']; ?></td>
                            <td class="pk"><?php echo $fetch['pkkills']; ?></td>
                            <td><?php echo $fetch['onlinetime']; ?></td>
                        </tr>
                        <?php
                    }
                }
